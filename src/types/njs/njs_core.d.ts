...
interface StringConstructor {
  ...
  bytesFrom(
    bytes: string,
    encoding: Exclude<BufferEncoding, "utf8">,
  ): NjsByteString;
  /**
...
declare class Buffer extends Uint8Array {
  ...
  static alloc(
    size: number,
    fill?: NjsStringLike | Uint8Array | number,
  ...
  /**
     ...
     */
  static byteLength(
    value: NjsStringLike | Buffer | TypedArray | DataView | ArrayBuffer,
    encoding?: BufferEncoding,
  ): number;
  ...
  /**
     ...
     */
  static from(
    obj: { valueOf(): NjsStringLike | object },
    byteOffset?: number,
    length?: number,
  ): Buffer;
  /**
  ...
  /**
     ...
     */
  fill(
    value: NjsStringLike | Uint8Array | number,
    offset?: number,
    end?: number,
    encoding?: BufferEncoding,
  ): this;
  ...
  /**
     ...
     */
  includes(
    value: NjsStringLike | number | Uint8Array,
    byteOffset?: number,
    encoding?: BufferEncoding,
  ): boolean;
