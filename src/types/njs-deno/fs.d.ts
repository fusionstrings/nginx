...
declare module "fs" {
  ...
  interface Promises {
    ...
    readdir(
      path: PathLike,
      options?: { encoding?: "utf8"; withFileTypes?: false } | "utf8",
    ): Promise<string[]>;
    readdir(
      path: PathLike,
    ...
    readdir(
      path: PathLike,
      options: { encoding?: "utf8" | "buffer"; withFileTypes: true },
    ): Promise<Dirent[]>;
    ...
    readFile(
      path: PathLike,
      options: { encoding?: FileEncoding; flag?: OpenMode } | FileEncoding,
    ): Promise<string>;
